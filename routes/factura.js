...
import controllerFacturas from '../controllers/factura.js'
...
router.get('/listar/admin',[
    validarJWT,
    esAdminRole
], controllerFacturas.listarfacturas)

//obtener categorias - usuario
/*router.get('/listar',[
    
], controllerFacturas.listar)
...
router.post('/guardar',[
    ...
    validarCampos
], controllerFacturas.guadarFactura) 
...
router.put('/modificar/:id',[
    ...
    check('id').custom( existeIdProduc),
    validarCampos,
], controllerFacturas.modificarfactura);
...
router.delete('/eliminar/:id',[  
    ...
    check('id', ).custom( existeIdProduc),
    validarCampos,
], controllerFacturas.eliminarFactura,)
